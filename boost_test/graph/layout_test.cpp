...
//            {
//                if ((int) position[*vi][0] == x && (int) position[*vi][1] == y) break;
//            }
//
...
//    {
//        out << "  n" << get(vertex_index, g, *vi) << "[ pos=\"" << (int) position[*vi][0] + 25
//                << ", " << (int) position[*vi][1] + 25 << "\" ];\n";
//    }
//
...
//void test_circle_layout(Graph*, typename graph_traits<Graph>::vertices_size_type n)
//{
...
//
//    template<typename Graph>
//    bool operator()(double delta_p, typename boost::graph_traits<Graph>::vertex_descriptor /*p*/,
...
//
//    bool ok = kamada_kawai_spring_layout(g, get(vertex_position, g), get(edge_weight, g),
...
//
//template<typename Graph>
//void test_cube(Graph*)
//{
//    enum
//    {
//        A, B, C, D, E, F, G, H
//    };
//    simple_edge cube_edges[12] = { { A, E }, { A, B }, { A, D }, { B, F }, { B, C }, { C, D }, { C,
//            G }, { D, H }, { E, H }, { E, F }, { F, G }, { G, H } };
//
...
//
//    bool ok = kamada_kawai_spring_layout(g, get(vertex_position, g), get(edge_weight, g),
//            square_topology<>(50.0), side_length(50.0), kamada_kawai_done());
//    BOOST_CHECK(ok);
//
...
//
//template<typename Graph>
//void test_triangular(Graph*)
//{
//    enum
//    {
//        A, B, C, D, E, F, G, H, I, J
//    };
//    simple_edge triangular_edges[18] = { { A, B }, { A, C }, { B, C }, { B, D }, { B, E }, { C, E },
//            { C, F }, { D, E }, { D, G }, { D, H }, { E, F }, { E, H }, { E, I }, { F, I },
//            { F, J }, { G, H }, { H, I }, { I, J } };
//
...
//    circle_graph_layout(g, get(vertex_position, g), 25.0);
//
//    bool ok = kamada_kawai_spring_layout(g, get(vertex_position, g), get(edge_weight, g), topology,
...
//    std::vector<Topology::point_difference_type> displacements(num_vertices(g));
//    fruchterman_reingold_force_directed_layout(g, get(vertex_position, g), topology,
//            attractive_force(square_distance_attractive_force()).cooling(
...
//
//template<typename Graph>
//void test_disconnected(Graph*)
//{
//    enum
//    {
//        A, B, C, D, E, F, G, H
//    };
//    simple_edge triangular_edges[13] = { { A, B }, { B, C }, { C, A }, { D, E }, { E, F }, { F, G },
//            { G, H }, { H, D }, { D, F }, { F, H }, { H, E }, { E, G }, { G, D } };
//
