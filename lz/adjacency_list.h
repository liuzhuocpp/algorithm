...
class AdjacencyList;
    ...
    class OutEdgeIterator:
    		public IteratorFacade<
				...
				>
	{
    	template<typename Directed, typename VP, typename EP, typename GP>
	...
	public :
		...
		auto operator[](typename GraphTraits<G>::VertexDescriptor u)
    ...
    class EdgePropertyMap
   	...
   	public :
       	...
       	auto operator[](typename GraphTraits<G>::EdgeDescriptor e)
...
//        const EdgeData& edgeData(EdgeDescriptor e) const { return this->e[e];}
    ...
    public:
        ...
        explicit AdjacencyListBase(int n = 0, const VP & vp = VP())
        {
        ...
        {
            return make_pair(OutEdgeIterator(this->derived().vertexData(u).head, this),
                             OutEdgeIterator(-1, this )) ;
        }

        EdgeDescriptor addSingleEdge(int a, int b, const EP &ep = EP())
        {
